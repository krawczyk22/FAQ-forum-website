...
describe('register', () => {
	...
	test('register one user missing credential username', async done => {
		// start generating a trace file
		//await page.tracing.start({path: 'trace/add_one_item_har.json',screenshots: true})
		await har.start({ path: 'trace/add_one_item_trace.har' })
		// ARRANGE
	...
	test('register one user missing credential password', async done => {
		// start generating a trace file
		//await page.tracing.start({path: 'trace/add_one_item_har.json',screenshots: true})
		await har.start({ path: 'trace/add_one_item_trace.har' })
		// ARRANGE
...
describe('login', () => {
	...
	test('login one user missing credential username', async done => {
		// start generating a trace file
		//await page.tracing.start({path: 'trace/add_login_har.json',screenshots: true})
		await har.start({ path: 'trace/add_add_login_har_trace.har' })
		// ARRANGE
	...
	test('login one user missing credential password', async done => {
		// start generating a trace file
		//await page.tracing.start({path: 'trace/add_login_har.json',screenshots: true})
		await har.start({ path: 'trace/add_add_login_har_trace.har' })
		// ARRANGE
...
describe('add question', () => {
	...
	test('add one question missing credential title', async done => {
		// start generating a trace file
		//await page.tracing.start({path: 'trace/add_login_har.json',screenshots: true})
		await har.start({ path: 'trace/add_add_question_har_trace.har' })
		// ARRANGE
        ...
        await page.type('textarea[name=title]', '')
		await page.type('textarea[name=description]', 'sample description')
		await page.click('input[type=submit]')
		await page.waitForSelector('h1')
		await page.waitFor(1000) // sometimes you need a second delay
	...
	test('add one question missing credential description', async done => {
		// start generating a trace file
		//await page.tracing.start({path: 'trace/add_login_har.json',screenshots: true})
		await har.start({ path: 'trace/add_add_question_har_trace.har' })
		// ARRANGE
        ...
        await page.type('textarea[name=title]', 'sampleTitle')
		await page.type('textarea[name=description]', '')
		await page.click('input[type=submit]')
		await page.waitForSelector('h1')
		await page.waitFor(1000) // sometimes you need a second delay
